{-# LANGUAGE RankNTypes #-}
-- | Sort operators for profunctor-based discrimination.
--
-- The 'Sort' carrier type lives in "Data.Profunctor.Optic.Carrier".
-- This module provides carriers that produce 'Map's, and operators
-- that compose 'Lens'' optics with Sort carriers.
--
-- For backend-specific operators (Vector, ByteString, Text, HashMap),
-- see @profunctor-optics-sort@.
...
import Prelude (Int, Char, String, Ord, Monoid, Bounded, Enum, Eq, seq,
                (+), (-), length, head, map, fst, snd, foldMap, foldr, foldr1,
                id, const, (.), ($), (!!), flip, fmap)
