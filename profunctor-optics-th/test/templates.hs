...
makeOpticsFor [("_terrain", "allTerrain"), ("_dunes", "allTerrain")] ''Perambulation
...
makeOpticsFor [("taskOutput", "outputLens"), ("taskState", "stateLens"), ("taskStop", "stopLens")] ''Task
...
makeOptics ''Rank2Tests

checkR2length :: View Rank2Tests ([a] -> Int)
...
makeOpticsWith (opticRules & lensField .~ underscoreNoPrefixNamer ) ''CheckUnderscoreNoPrefixNamer
...
makeOpticsWith (opticRules & lensField .~ (mappingNamer (return . ("hogehoge_" ++)))) ''CheckMappingNamer
...
makeOpticsWith (opticRules & lensField .~ (lookingupNamer [("fieldLookingupNamer", "foobarFieldLookingupNamer")])) ''CheckLookingupNamer
...
makeOpticsWith (defaultFieldRules & lensField .~ underscoreNamer) ''CheckUnderscoreNamer
...
makeOpticsWith (defaultFieldRules & lensField .~ camelCaseNamer) ''CheckCamelCaseNamer
...
makeOpticsWith (defaultFieldRules & lensField .~ abbreviatedNamer ) ''CheckAbbreviatedNamer
