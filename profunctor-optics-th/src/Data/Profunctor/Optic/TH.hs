...
import Data.Profunctor.Optic hiding (cons)
import Data.Profunctor.Optic.TH.Internal.Product
import Data.Profunctor.Optic.TH.Internal.Sum
...
--
-- @
-- 'makeFieldData.Profunctor.Optic' = 'makeFieldLabelsWith' 'fieldLabelsRules'
-- @
...
makeLenses = makeFieldData.Profunctor.Optic lensRules
...
makeLensesFor fields = makeFieldData.Profunctor.Optic (lensRulesFor fields)

-- | Build field optics with a custom configuration.
makeLensesWith :: LensRules -> Name -> DecsQ
makeLensesWith = makeFieldData.Profunctor.Optic
...
declareLensesWith rules = declareWith $ \dec -> do
  emit =<< lift (makeFieldData.Profunctor.OpticForDec' rules dec)
  return $ stripFields dec
...
makeClassy = makeFieldData.Profunctor.Optic classyRules
...
makeClassy_ = makeFieldData.Profunctor.Optic classyRules_
...
makeClassyFor clsName funName fields = makeFieldData.Profunctor.Optic $
...
makeFields = makeFieldData.Profunctor.Optic camelCaseFields
...
makeFieldsNoPrefix = makeFieldData.Profunctor.Optic classUnderscoreNoPrefixFields
